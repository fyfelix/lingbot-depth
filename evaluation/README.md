...
enabled, the normal preview is retained and KITTI-specific outputs are stored
under `kitti_visualization/predictions/<scene>/<frame>.jpg` and
`kitti_visualization/pointclouds/<scene>/<frame>.jpg`.
...
kitti_visualization/predictions/<scene>/<frame>.jpg  # KITTI only
kitti_visualization/pointclouds/<scene>/<frame>.jpg   # KITTI only
